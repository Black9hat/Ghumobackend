...
const transactionSchema = new mongoose.Schema(
  {
    ...
    type: {
      type: String,
      enum: ['credit', 'debit', 'commission', 'plan_purchase', 'referral_bonus', 'refund'],
      required: true,
      index: true,
      ...
      // referral_bonus: referral reward credited to the driver
      // refund: withdrawal/transaction refund
    },
    ...
    paymentMethod: {
      type: String,
      enum: ['upi', 'card', 'netbanking', 'wallet', 'cash', 'razorpay', 'incentive', 'unknown'],
      default: 'unknown',
    },
...
const walletSchema = new mongoose.Schema(
  {
    ...
    pendingWithdrawalAmount: {
      ...
      default: 0,
      min: 0,
      description: 'Withdrawal amount reserved but not yet paid',
    },
