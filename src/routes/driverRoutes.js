...
import {
  ...
  clearDriverState,
  setGoToDestination,
  getGoToDestinationStatus,
  saveGoToDestinationLocation,
  getGoToDestinationLocations,
  toggleGoToDestinationLocation,
  updateGoToDestinationLocation,
  deleteGoToDestinationLocation,
...
router.get("/nearby", protect, async (req, res) => {
  try {
    ...
    // ✅ FIX: Only find TRULY online drivers with recent location updates
...
/**
 * @route   POST /api/driver/go-to-destination
 * @desc    Enable / Disable Go To Destination
 * @access  Protected
 */
router.post(
  "/go-to-destination",
...
router.get(
  "/go-to-destination/status",
  protect,
  getGoToDestinationStatus
);

/**
 * @route   POST /api/driver/go-to-destination/save
 * @desc    Save a go-to-destination location (Home, Office, Hotel, Gym, Other)
 * @access  Protected
 */
router.post(
  "/go-to-destination/save",
  protect,
  saveGoToDestinationLocation
);

/**
 * @route   GET /api/driver/go-to-destination/saved-locations
 * @desc    Get all saved go-to-destination locations
 * @access  Protected
 */
router.get(
...
/**
 * @route   POST /api/driver/go-to-destination/toggle/:locationId
 * @desc    Toggle a location active/inactive
 * @access  Protected
 */
router.post(
  "/go-to-destination/toggle/:locationId",
  protect,
  toggleGoToDestinationLocation
);

/**
 * @route   PUT /api/driver/go-to-destination/location/:locationId
 * @desc    Update location name
 * @access  Protected
 */
router.put(
  "/go-to-destination/location/:locationId",
  protect,
  updateGoToDestinationLocation
);

/**
 * @route   DELETE /api/driver/go-to-destination/location/:locationId
...
/**
 * @route   GET /api/driver/document-image/:docId
 * @desc    Serve driver document image by document ID
 * @access  Protected
 */
router.get("/document-image/:docId", protect, getDriverDocumentImage);
